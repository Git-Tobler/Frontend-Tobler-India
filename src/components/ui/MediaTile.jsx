/* Blueprint-style stand-in for photography that hasn't been shot/supplied
   yet: a dark technical panel with a large line icon, in the same visual
   language as the hero/CTA bands. Drop-in replacement for an <img> — swap
   back to a real photo by rendering one instead once assets are available. */
